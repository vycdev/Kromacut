...
- **Community showcase** - Added seven community showcase images to the landing page: a finished multicolor King of Hearts with its slicer preview, two credited Hobbits and Dragons views with source links, and an honest Hope poster prediction/slicer/result field test documenting incomplete color matches. Each card shows its creator, view type, available dimensions, and source action below the image, followed by a GitHub pull-request invitation for new showcases and contributions.
