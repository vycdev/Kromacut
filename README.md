...
| **Preserve color separation** | (Requires Enhanced color matching) Keeps distinct 2D image colors assigned to distinct printable colors when the stack has enough printable colors. Mutually exclusive with Height dithering. |
